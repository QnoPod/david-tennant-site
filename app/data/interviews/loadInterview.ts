...
const transcriptLoaders: Record<string, TranscriptLoader> = {
  ...
  "david-tennant-nafessa-rivals-deadly-twist-tv-insider": async () =>
  ...
  "david-tennant-getting-the-band-back-together-radio-times-2023": async () =>
    (await import("./transcripts/davidTennantDoctorWhoBandRadioTimesTranscript")).davidTennantDoctorWhoBandRadioTimesTranscript,
  "david-tennant-kissing-michael-sheen-guardian-2024": async () =>
    (await import("./transcripts/davidTennantKissingMichaelSheenGuardianTranscript")).davidTennantKissingMichaelSheenGuardianTranscript,
  ...
  "david-tennant-deadwater-fell-channel4-2019": async () =>
    (await import("./transcripts/davidTennantDeadwaterFellChannel4Transcript")).davidTennantDeadwaterFellChannel4Transcript,
  "david-tennant-doctor-detective-nihilistic-sexual-athlete-time-out-2017": async () =>
  ...
  "david-tennant-it-just-feels-scary-guardian-2009": async () =>
    (await import("./transcripts/davidTennantScaryGuardian2009Transcript")).davidTennantScaryGuardian2009Transcript,
  "david-tennant-bedpost-few-notches-guardian-2011": async () =>
    (await import("./transcripts/davidTennantBedpostGuardian2011Transcript")).davidTennantBedpostGuardian2011Transcript,
  "david-tennant-king-of-cliffhanger-guardian-2014": async () =>
    (await import("./transcripts/davidTennantKingOfCliffhangerGuardianTranscript")).davidTennantKingOfCliffhangerGuardianTranscript,
