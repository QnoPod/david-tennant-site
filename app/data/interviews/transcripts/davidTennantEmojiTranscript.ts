export const davidTennantEmojiTranscript = [
  {
    ...
    "ja": "たくさんの子供がいれば、若々しく、テクノロジーにも詳しくて、世の中のことに精通して いそうに思えますよね。でもデイヴィッド・テナント、あなたは違ったようです。最近、自分が テキストメッセージなどの世界から取り残されていることに気づいたそうですね。"
  },
  {
    ...
    "ja": "ええ、そうなんです。新しい仕事を始める時、MeToo運動の影響もあって、職場を安全にす るための素晴らしい進歩がたくさんありますよね。だから今、様々な企業がそれぞれ違った対応 をしていて、僕がやっていた番組でも、あるビデオを最初から最後まで座って見て、確実に見た と証明しなければならなかったんです。"
  },
  {
    "speakerEn": "David Tennant",
    "speakerJa": "デイヴィッド・テナント",
    ...
    "ja": "職場で許されること、許されないことを丁寧に説明してくれるんですが、その映像の最後の 方で、携帯電話でのコミュニケーション方法や、何が適切で何が不適切かについて話していたん です。そこで「ナス(eggplant)の絵文字は、単なるナスではないことを覚えておきましょう」 と。それで終わりなんですよ!"
  },
  {
    "speakerEn": "David Tennant",
    "speakerJa": "デイヴィッド・テナント",
    ...
    "ja": "僕は「ナス(eggplant)って一体何なんだ?」と取り残されてしまって。あれはオベルジー ヌ(イギリス英語でナス)ですよね?でもそういう意味じゃないんです!全く知らなかったんで すが、そこには全く別の言語体系があって..."
  },
  {
    "speakerEn": "Graham Norton",
    "speakerJa": "グラハム・ノートン",
  ...
  },
  {
    ...
    "ja": "...大抵は食べ物をベースにして、別のものを表しているんです!タコスを食べるために誰か を誘うのも、簡単に誤解される可能性があると分かりました。知ってましたか?"
  },
  {
  ...
  },
  {
    ...
    "ja": "本当に純真さが失われていきますよ!僕は「わあ、ドーナツだ!」って感覚で来ているの に。何が起きているのかさっぱりです。明らかに地雷原ですよ。"
  },
  {
    "speakerEn": "Graham Norton",
    "speakerJa": "グラハム・ノートン",
  ...
  },
  {
    ...
    "ja": "だって、絵文字はそのままの意味を表すものだと思っていたからです!学ばなきゃいけない 全く別の言語があるなんて知りませんでしたよ!"
  },
  {
    "speakerEn": "Graham Norton",
    "speakerJa": "グラハム・ノートン",
  ...
  },
  {
    ...
    "ja": "でもね、ファンが手放さない、ドクターとしてのあなたの画像があるんです。これなんです が、すごくシンプルなものです。あなたが通りで、ただこうしているだけ。で、このミームは 「いるべきではない場所にいるデイヴィッド・テナント」と呼ばれています。"
  },
  {
    "speakerEn": "Graham Norton",
    "speakerJa": "グラハム・ノートン",
    ...
    "ja": "まあ、ナスの絵文字を知らないなら、ミームを見ている可能性はすごく低そうですけどね。 当然ながら、初心者向けなのは、もちろん、ロイヤルウェディングですね。他にどこにいるって いうんでしょう?"
  },
  {
    "speakerEn": "Graham Norton",
    "speakerJa": "グラハム・ノートン",
    ...
    "ja": "次は教育現場。あなただけが答えを知っていて、他の誰も知りません。完璧です。ああ、ア イススケート!とても上手ですね。次は映画の中。ライオン・キングですね。そして最後は、シ ンクロナイズドスイミング!お見事!"
  }
] as const;
