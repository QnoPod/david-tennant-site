...
export default function ProfilePage() {
  return <main id="main-content">
    ...
    <section className="section shell profile-intro">
      <img src="/images/david-tennant-optimized.webp" alt="デイヴィッド・テナント" width="1600" height="900" fetchPriority="high" decoding="async" />
      <div><p className="eyebrow">AT A GLANCE</p><p>ヒーローから悪役、実在の人物、シェイクスピア作品まで幅広い役を演じる。テレビの人気シリーズだけでなく、劇場、ラジオ、アニメーション、朗読でも活動を続けている。</p>
    ...
    <aside className="profile-sources section--paper"><div className="shell"><p className="eyebrow">SOURCES & FURTHER READING</p><div><a href="https://ja.wikipedia.org/wiki/%E3%83%87%E3%82%A4%E3%83%B4%E3%82%A3%E3%83%83%E3%83%89%E3%83%BB%E3%83%86%E3%83%8A%E3%83%B3%E3%83%88" target="_blank" rel="noreferrer">Wikipedia（日本語） ↗</a><a href="https://www.rcs.ac.uk/support-us/ways-to-support/scholarship-funds/georgia-david-tennant/" target="_blank" rel="noreferrer">Royal Conservatoire of Scotland ↗</a><a href="https://www.pbs.org/wgbh/masterpiece/specialfeatures/five-intriguing-facts-about-actor-david-tennant/" target="_blank" rel="noreferrer">PBS Masterpiece ↗</a></div></div></aside>
  </main>;
}
