...
export default async function WorksPage() {
  ...
  return <main id="main-content"><PageHero eyebrow="FILMOGRAPHY" title="WORKS" description="映画、テレビ、舞台、声の出演。公開年や役名から検索" /><Suspense fallback={null}><WorksExplorer works={works} /></Suspense></main>;
}
